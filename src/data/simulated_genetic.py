...
from src.data.simulated_genetic_dataset import StdPopSimDataHumanDemoModel

class SimulatedGeneticDataModule(LightningDataModule):
    """
    ...
    def __init__(
        ...
        num_workers: int = 0,
        cache_dir: str = "./cache",
        demographic_model: str = "OutOfAfrica_3G09",
        ...
        demographic_model : str, default='OutOfAfrica_3G09'
            Identifier for the demographic model to use from `stdpopsim`. Examples include:
            'OutOfAfrica_3G09', 'Africa_1T12', 'AmericanAdmixture_4B11', etc.
    ...
    def setup(self, stage: str = None):
        if self.mode == "full":
            self.train_dataset = StdPopSimDataHumanDemoModel(**self.dataset_config)
            self.test_dataset = self.train_dataset

        elif self.mode == "split":
            self.dataset = StdPopSimDataHumanDemoModel(**self.dataset_config)
...
if __name__ == "__main__":
    data_module = SimulatedGeneticDataModule(
        batch_size=64,
        test_split=0.2,
