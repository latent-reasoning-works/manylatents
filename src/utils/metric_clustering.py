...
def sweep_kmeans(data, true_labels, param_grid, **kwargs):
    """
    Sweep kmeans parameters using a grid and calculate ARI.
    ...
    for params in param_combinations:
        ...
        # Fit HDBSCAN
        clusterer = sklearn.cluster.KMeans(**clusterer_params)
        cluster_labels = clusterer.fit_predict(data)
...
def make_confusion_heatmap(true_labels, clusterer_labels, ax=None, colorbar=True, method = 'HDBSCAN', plot = True):
    """
